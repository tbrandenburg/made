...
# Commit & Push: Complete Git Workflow

## Philosophy

This workflow ensures changes are properly isolated in branches, committed with rich context for future AI agents, and pushed with comprehensive PR descriptions.

**Every change should tell a story that future agents can understand.**
