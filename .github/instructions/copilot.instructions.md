...
This path-specific instruction file ensures that all file contexts within the MADE repository receive the same comprehensive guidance, regardless of the specific path being worked on.
